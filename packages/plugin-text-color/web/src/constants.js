...
export const DEFAULT_STYLE_SELECTION_PREDICATE = style => isTextColor(style);

export const DEFAULT_STYLE_SELECTION_HIGHLIGHT_PREDICATE = style => isTextHighlight(style);
