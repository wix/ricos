...
import { Image, SettingsPanelFooter } from 'wix-rich-content-plugin-commons';
import { InputWithLabel, SettingsSection, FileInput } from 'wix-rich-content-ui-components';
