...
import { Image, SettingsSection, SettingsPanelFooter } from 'wix-rich-content-plugin-commons';
import { FileInput, InputWithLabel } from 'wix-rich-content-ui-components';
