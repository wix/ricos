...
import { FileInput, Image, SettingsPanelFooter } from 'wix-rich-content-plugin-commons';
import { InputWithLabel, SettingsSection } from 'wix-rich-content-ui-components';
