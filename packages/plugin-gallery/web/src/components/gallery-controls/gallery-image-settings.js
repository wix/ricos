...
import { FileInput, Image, InputWithLabel } from 'wix-rich-content-plugin-commons';
import { SettingsSection, SettingsPanelFooter } from 'wix-rich-content-ui-components';
