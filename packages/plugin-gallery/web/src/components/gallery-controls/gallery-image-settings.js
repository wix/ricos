...
import { FileInput, SettingsSection, SettingsPanelFooter } from 'wix-rich-content-plugin-commons';
import { Image, InputWithLabel } from 'wix-rich-content-ui-components';
