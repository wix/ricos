...
export interface GalleryConfig {
  alignment: GalleryConfig_GalleryAlignment;
  size: GalleryConfig_GallerySize;
  layout?: string;
  spacing?: number;
  key?: string;
  spoiler?: Spoiler;
...
export const enum GalleryConfig_GallerySize {
  CONTENT = 'CONTENT',
  SMALL = 'SMALL',
...
export function galleryConfig_GallerySizeFromJSON(object: any): GalleryConfig_GallerySize {
  switch (object) {
    case 0:
    case 'CONTENT':
      return GalleryConfig_GallerySize.CONTENT;
    case 1:
    case 'SMALL':
      return GalleryConfig_GallerySize.SMALL;
    case 2:
    case 'FULL_WIDTH':
      return GalleryConfig_GallerySize.FULL_WIDTH;
    case -1:
    case 'UNRECOGNIZED':
    default:
      return GalleryConfig_GallerySize.UNRECOGNIZED;
  }
}

export function galleryConfig_GallerySizeToJSON(object: GalleryConfig_GallerySize): string {
  switch (object) {
    case GalleryConfig_GallerySize.CONTENT:
      return 'CONTENT';
    case GalleryConfig_GallerySize.SMALL:
      return 'SMALL';
    case GalleryConfig_GallerySize.FULL_WIDTH:
      return 'FULL_WIDTH';
    default:
      return 'UNKNOWN';
  }
...
export const enum GalleryConfig_GalleryAlignment {
  LEFT = 'LEFT',
  RIGHT = 'RIGHT',
  CENTER = 'CENTER',
  UNRECOGNIZED = 'UNRECOGNIZED',
...
export function galleryConfig_GalleryAlignmentFromJSON(
  object: any
): GalleryConfig_GalleryAlignment {
  switch (object) {
    case 0:
    case 'LEFT':
      return GalleryConfig_GalleryAlignment.LEFT;
    case 1:
    case 'RIGHT':
      return GalleryConfig_GalleryAlignment.RIGHT;
    case 2:
    case 'CENTER':
      return GalleryConfig_GalleryAlignment.CENTER;
    case -1:
    case 'UNRECOGNIZED':
    default:
      return GalleryConfig_GalleryAlignment.UNRECOGNIZED;
  }
}

export function galleryConfig_GalleryAlignmentToJSON(
  object: GalleryConfig_GalleryAlignment
): string {
  switch (object) {
    case GalleryConfig_GalleryAlignment.LEFT:
      return 'LEFT';
    case GalleryConfig_GalleryAlignment.RIGHT:
      return 'RIGHT';
    case GalleryConfig_GalleryAlignment.CENTER:
      return 'CENTER';
    default:
      return 'UNKNOWN';
  }
...
const baseGalleryConfig: object = {
  alignment: GalleryConfig_GalleryAlignment.LEFT,
  size: GalleryConfig_GallerySize.CONTENT,
};
...
export const GalleryConfig = {
  fromJSON(object: any): GalleryConfig {
    ...
    if (object.alignment !== undefined && object.alignment !== null) {
      message.alignment = galleryConfig_GalleryAlignmentFromJSON(object.alignment);
    } else {
      message.alignment = GalleryConfig_GalleryAlignment.LEFT;
    }
    if (object.size !== undefined && object.size !== null) {
      message.size = galleryConfig_GallerySizeFromJSON(object.size);
    } else {
      message.size = GalleryConfig_GallerySize.CONTENT;
    }
  ...
  toJSON(message: GalleryConfig): unknown {
    ...
    message.alignment !== undefined &&
      (obj.alignment = galleryConfig_GalleryAlignmentToJSON(message.alignment));
    message.size !== undefined && (obj.size = galleryConfig_GallerySizeToJSON(message.size));
