...
import { RichContent, Node_Type, ImageData, DividerData, ParagraphData } from 'ricos-schema';
...
export class RicosContentExtractor implements ContentExtractor {
  ...
  getParagraphs(content: RichContent) {
    return this.getNodeDataByType(content, Node_Type.PARAGRAPH) as ParagraphData[];
  }
}
