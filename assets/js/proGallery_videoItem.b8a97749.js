...
/* harmony import */ var pro_gallery_lib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(42);
/* harmony import */ var pro_gallery_lib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(27);
/* harmony import */ var pro_gallery_lib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(65);
/* harmony import */ var _galleryComponent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(53);




var VideoItem = /** @class */ (function (_super) {
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"])(VideoItem, _super);
    ...
    VideoItem.prototype.dynamiclyImportVideoPlayers = function () {
        ...
        if (!(pro_gallery_lib__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"] && pro_gallery_lib__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].ReactPlayer)) {
            __webpack_require__.e(/* import() | proGallery_reactPlayer */ 4).then(__webpack_require__.t.bind(null, 1403, 7)).then(function (ReactPlayer) {
        ...
        !(pro_gallery_lib__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"] && pro_gallery_lib__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].Vimeo) &&
            ...
            __webpack_require__.e(/* import() | proGallery_vimeoPlayer */ 7).then(__webpack_require__.bind(null, 1421)).then(function (Player) {
        ...
        !(pro_gallery_lib__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"] && pro_gallery_lib__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].Hls) &&
            this.isHLSVideo()) {
            __webpack_require__.e(/* import() | proGallery_HlsPlayer */ 3).then(__webpack_require__.t.bind(null, 1422, 7)).then(function (Player) {
    ...
    VideoItem.prototype.createPlayerElement = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(PlayerElement, { className: 'gallery-item-visible video gallery-item', id: "video-" + this.props.id, width: "100%", height: "100%", url: url, alt: this.props.alt ? this.props.alt : 'untitled video', loop: !!this.props.styleParams.videoLoop, ref: function (player) { return (_this.video = player); }, volume: this.props.styleParams.videoSound ? 0.8 : 0, playing: this.props.playing, onEnded: function () {
                ...
                _this.props.actions.eventsListener(pro_gallery_lib__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].events.VIDEO_ERROR, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, _this.props), { videoError: e }));
    ...
    VideoItem.prototype.render = function () {
        ...
        var _b = this.props.imageDimensions || {}, marginLeft = _b.marginLeft, marginTop = _b.marginTop, restOfDimensions = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"])(_b, ["marginLeft", "marginTop"]);
        var video = (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: baseClassName, "data-hook": "video_container-video-player-element", key: 'video_container-' + this.props.id, style: pro_gallery_lib__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].deviceHasMemoryIssues() || this.state.ready
                ...
                : Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({ backgroundImage: "url(" + this.props.createUrl(pro_gallery_lib__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].urlSizes.RESIZED, pro_gallery_lib__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"].urlTypes.HIGH_RES) + ")" }, restOfDimensions) },
