...
/* harmony import */ var pro_gallery_lib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(383);
/* harmony import */ var pro_gallery_lib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(65);
/* harmony import */ var pro_gallery_lib__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(42);
/* harmony import */ var _scrollHelper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(170);
...
var VideoScrollHelper = /** @class */ (function () {
    function VideoScrollHelper(config) {
        ...
        this.trigger = Object.assign.apply(Object, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__spreadArrays"])([{}], Object.keys(VIDEO_EVENTS).map(function (key) {
            var _a;
            return (_a = {},
        ...
        if (lastItemCount === newItemCount) {
            ...
            newItems.forEach(function (item) {
                if (item.type === 'video' ||
                    ...
                    _this.videoItems.push(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, item), { videoPlayRating: item.idx }));
                }
            });
        }
    };
