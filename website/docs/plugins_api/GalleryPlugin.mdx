...
:::note
By default gallery allows uploading images only, to enable videos pass `accept='image/*,video/*'` via config. <br />
Refrain from passing any other values, gallery doesn't support anything but images and videos, any unsupported file type upload would trigger an error.
:::
