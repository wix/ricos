...
| `disableExpand` (deprecated!) | disables expanding images & fullscreen | false         | No           | \*viewer this option is deprecated! whoever used will still get the same behavior. note that now the initial value should be set in the editor config |
