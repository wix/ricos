...
Which video buttons will display - array with videoButtonsTypes types [video, soundCloud].
For provide buttons type you should import videoButtonsTypes.
...
For consume soundCloud plugin you should consume Video plugin and pass to plugin config:

1. exposeButtons: [videoButtonsTypes.soundCloud] or [videoButtonsTypes.video, videoButtonsTypes.soundCloud]
