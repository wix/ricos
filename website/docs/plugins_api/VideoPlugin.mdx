...
#### This option is no longer in use, data that already uses this option will go through data fixing process.

```jsx
disableDownload?: boolean;
```

Video without download example
...
### `Editor disableDownload`

#### The config is used to define the initial download behavior
