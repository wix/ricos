...
Check this [Theme Playground](http://rich-content-storybook-master.surge.sh/?path=/story/ricos--ricos-theme) to understand the influence of each color on plugins, toolbars and modals.
...
Palette can receive 3 more optional fields:
