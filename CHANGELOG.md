...
- `ui-components`
  - [#2562](https://github.com/wix-incubator/rich-content/pull/2562) moved selectionList component into ui-components folder
...
- `editor`
  - [#2397](https://github.com/wix/ricos/pull/2397) fix undo experiment accordion crash
