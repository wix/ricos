...
### :bug: Bug Fix
- `emoji`
  - [#674](https://github.com/wix-incubator/rich-content/pull/674) mouse cursor is shown as pointer on the actual icons + fix the emoji plugin in RTL+ remove the emoji plugin from mobile+ refactoring the emoji modal and giphy modal to be more consistent
- `common`
