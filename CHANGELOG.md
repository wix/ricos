...
### :bug: Bug Fix
- `emoji`
  - [#669](https://github.com/wix-incubator/rich-content/pull/570) mouse cursor is shown as pointer on the actual icons + fix the emoji plugin in RTL+ position the modal at the bottom in mobile+ refactoring the emoji modal and giphy modal to be more consistent
- `common`
