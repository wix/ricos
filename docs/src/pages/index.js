...
const features = [
	{
		...
		description: (
			<>
				Through theming, plugins and styles, make the right decisions for your
				product.
			</>
		),
	},
			...
			<header className={classnames(styles.heroBanner, styles.hero)}>
				<div className="container">
					<h1 className={styles.heroProjectTagline}>
						...
						<span className={styles.heroProjectKeywords}>rich</span> content
						editor with an{" "}
						<span className={styles.heroProjectKeywords}>extensible</span>{" "}
						plugin system
					</h1>
