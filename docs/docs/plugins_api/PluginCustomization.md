...
Both [editor-example](https://github.com/wix/rich-content/blob/master/examples/main/shared/editor/EditorPlugins.jsx) and [viewer-example](https://github.com/wix/rich-content/blob/master/examples/main/shared/viewer/ViewerPlugins.jsx) apps demonstrate the plugin customization capabilities.
