...
`QUOTA_STORAGE_VISITOR` the storage space in the site is full (user of user). <br />
`QUOTA_STORAGE_OWNER` the storage space in the site is full, supports an argument `upgradeUrl` to upgrade the site's plan. <br />
`QUOTA_VIDEO_VISITOR` video hours on the site have reached the maximum (user of user). <br />
`QUOTA_VIDEO_OWNER` video hours on the site have reached the maximum, supports an argument `upgradeUrl` to upgrade the site's plan. <br />
