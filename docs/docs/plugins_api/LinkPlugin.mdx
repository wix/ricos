...
```jsx
https://wix.github.io/ricos/docs/plugins_api/LinkPlugin#top-section
```
...
or if you wish to use Custom Link then,

```jsx
onClick?: (CustomLinkData: any) => void
```

`onClick` is a function provided to fire `onClick` event on your custom link data.
