...
>	!TODO - The above suggests adding plugins - would be nice to link out to a list of popular / avaliable / must have plugins somewhere. I know there's a section on plugins in the API, but no way to link to a page where they are all listed - right now they only exist as a list in website sidebar...