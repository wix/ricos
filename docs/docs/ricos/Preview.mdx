...
> !TODO - Since there is a whole section of the docs dedicated to the API, this can be confusing. I would suggest changing the title to "Preview API" or "Options" or "Tweaking the Preview", something like that.
...
> !TODO - the link above returns 404 for me
