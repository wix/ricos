...
- default value: [Default Transformation](https://github.com/wix/rich-content/blob/master/packages/preview/web/src/Components/default-transformation.ts)
...
- default value: [Default Interaction Map](https://github.com/wix/rich-content/blob/master/packages/preview/web/src/Interactions/interactionMap.tsx)
