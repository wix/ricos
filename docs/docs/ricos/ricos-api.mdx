...
We provide an option to change fullscreen's background and icon colors, if you choose to customize them make sure to pick colors that aren't too similar. <br />
