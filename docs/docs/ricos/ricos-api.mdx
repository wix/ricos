...
Any two letter string represing a [supported](https://github.com/wix/rich-content/tree/master/packages/common/web/statics/locale) locale. Determines the language and text direction.
