...
const RicosWithToolbarContainer = () => {
  ...
  return (
    <div>
      <RicosEditor textToolbarContainer={bottomToolbar} />
...
Set to true for rendering the text toolbar in a fixed position above the editor.

<div className="card">
  <RicosEditor textToolbarType="static" />
</div>
